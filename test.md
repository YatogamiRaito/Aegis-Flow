...
- `crates/crypto/src/tls.rs` (53/53)
...
### >90% Coverage 🟢
- `crates/proxy/src/discovery.rs` (71/72) 98.6%
...
- `crates/proxy/src/config.rs` (156/162) 96.3%
- `crates/crypto/src/attestation.rs` (208/217) 95.8%
- `crates/telemetry/src/ebpf/metrics.rs` (59/62) 95.1%
- `crates/genomics/src/vcf_parser.rs` (49/52) 94.2%
- `crates/genomics/src/bam_parser.rs` (86/92) 93.5%
...
### 70-90% Coverage 🟡
- `crates/crypto/src/stream.rs` (99/111) 89.2%
- `crates/energy/src/client.rs` (46/52) 88.5%
- `crates/proxy/src/green_wait.rs` (110/125) 88.0%
- `crates/proxy/src/dual_stack_server.rs` (56/64) 87.5%
- `crates/telemetry/src/ebpf/loader.rs` (20/23) 87.0%
- `crates/crypto/src/signing.rs` (252/296) 85.1%
- `crates/proxy/src/bootstrap.rs` (27/32) 84.4%
- `crates/proxy/src/health_server.rs` (56/67) 83.6%
- `crates/proxy/src/pqc_server.rs` (62/77) 80.5%
- `crates/proxy/src/quic_server.rs` (78/110) 70.9%
