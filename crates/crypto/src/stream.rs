    ...
    fn poll_read(
        ...
        loop {
            ...
            if me.read_buffer.len() < U32_SIZE {
                ...
                let n = ready!(poll_read_into(Pin::new(&mut me.stream), cx, &mut me.read_buffer))?;
                if n == 0 {
            ...
            let frame_len = u32::from_be_bytes(len_bytes) as usize;
             ...
             if frame_len < NONCE_SIZE + 16 { // Minimum: nonce + tag (empty payload)
            ...
            if me.read_buffer.len() < total_required {
                if me.read_buffer.capacity() < total_required {
                     me.read_buffer.reserve(total_required - me.read_buffer.len());
                }
