...
mod tests {
    ...
    fn test_load_from_file_der() {
        ...
        params
            .distinguished_name
            .push(DnType::CommonName, "test-der");
    ...
    fn test_verify_chain_trusted_ca_success() {
        ...
        leaf_params
            .distinguished_name
            .push(DnType::CommonName, "My Leaf");
    ...
    fn test_ipv6_san_ignored() {
        ...
        params
            .distinguished_name
            .push(DnType::CommonName, "ipv6-test");
        // Add an IPv6 address
    ...
    fn test_get_expiring_certs_logic() {
        ...
        manager
            .set_server_cert(expiring_server, "key".to_string())
            .unwrap();
    ...
    fn test_intermediate_ca_parsing() {
        ...
        // 5. Verify type
        assert_eq!(parsed.cert_type, CertType::IntermediateCa);
        assert_eq!(parsed.issuer_cn, "Root CA");
        assert_eq!(parsed.subject_cn, "Intermediate CA");
    }
